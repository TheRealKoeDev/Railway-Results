...
namespace KoeLib.Patterns.Railway.Tasks
{
    ...
    public static class TaskOfResultExtension
    {
        ...
        public static Task<Result> OnSuccess(this Task<Result> railsTask, Func<Result> onSuccess)
        {
            Args.ExceptionIfNull(railsTask, nameof(railsTask), onSuccess, nameof(onSuccess));
            return railsTask.ContinueWith(task => task.Result.OnSuccess(onSuccess));
        }

        public static Task<Result<TValue>> OnSuccess<TValue>(this Task<Result> railsTask, Func<Result<TValue>> onSuccess)
        {
            Args.ExceptionIfNull(railsTask, nameof(railsTask), onSuccess, nameof(onSuccess));
            return railsTask.ContinueWith(task => task.Result.OnSuccess(onSuccess));
        }
        ...
        public static Task<Result> OnError(this Task<Result> railsTask, Func<Result> onError)
        {
            Args.ExceptionIfNull(railsTask, nameof(railsTask), onError, nameof(onError));
            return railsTask.ContinueWith(task => task.Result.OnError(onError));
        }

        public static Task<ResultWithError<TError>> OnError<TError>(this Task<Result> railsTask, Func<ResultWithError<TError>> onError)
        {
            Args.ExceptionIfNull(railsTask, nameof(railsTask), onError, nameof(onError));
            return railsTask.ContinueWith(task => task.Result.OnError(onError));
        }
